...
function calcForwardKinematics(
  ...
  AIn?: Matrix4
    ...
    var A_TaiwanBear = A.multiply(M_TaiwanBear);


    const M_RJoint_Back_Upper_XYZ_L = new Matrix4(1.0,0.0,0.0,0.03032732382416725,0.0,-4.371138828673793e-08,1.0,0.45000001788139343,0.0,-1.0,-4.371138828673793e-08,-0.23499634861946106,0.0,0.0,0.0,1.0);
    var A_RJoint_Back_Upper_XYZ_L = A_TaiwanBear.multiply(M_RJoint_Back_Upper_XYZ_L);
    ...
    if (q.hasOwnProperty("RJoint_Back_Upper_XYZ_L")) {
        ...
        const Ry_RJoint_Back_Upper_XYZ_L = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    const M_RJoint_Back_Lower_Z_L = new Matrix4(1.0,1.5632423334315318e-14,-3.5762786865234375e-07,0.6865012049674988,-1.0369608636003646e-43,1.0,4.3711427366588396e-08,0.0002469271421432495,3.5762786865234375e-07,-4.3711427366588396e-08,1.0,0.17306020855903625,0.0,0.0,0.0,1.0);
    var A_RJoint_Back_Lower_Z_L = A_RJoint_Back_Upper_XYZ_L.multiply(M_RJoint_Back_Lower_Z_L);
    ...
    if (q.hasOwnProperty("RJoint_Back_Lower_Z_L")) {
        ...
        A_RJoint_Back_Lower_Z_L = A_RJoint_Back_Lower_Z_L.multiply(Rz_RJoint_Back_Lower_Z_L);  
    }   


    const M_RJoint_Back_Ankle_Z_L = new Matrix4(1.0,5.2108128603027895e-15,-1.1920928955078125e-07,0.6337858438491821,-5.210807778105106e-15,1.0,3.197441294480914e-14,2.558872154168057e-07,1.1920928955078125e-07,-3.1974433273599875e-14,1.0,-3.826122352279526e-08,0.0,0.0,0.0,1.0);
    var A_RJoint_Back_Ankle_Z_L = A_RJoint_Back_Lower_Z_L.multiply(M_RJoint_Back_Ankle_Z_L);
    ...
    if (q.hasOwnProperty("RJoint_Back_Ankle_Z_L")) {
        ...
        A_RJoint_Back_Ankle_Z_L = A_RJoint_Back_Ankle_Z_L.multiply(Rz_RJoint_Back_Ankle_Z_L);  
    }   


    const M_Effector_Back_L = new Matrix4(7.549789415861596e-08,3.258413983076025e-07,1.0,0.24104450643062592,1.7763556535541243e-14,-1.0,3.2584136988589307e-07,-0.1315731257200241,1.0,-5.8906465859667745e-15,-7.549790836947068e-08,-0.00037578781484626234,0.0,0.0,0.0,1.0);
    var A_Effector_Back_L = A_RJoint_Back_Ankle_Z_L.multiply(M_Effector_Back_L);
    ...
    var A_RJoint_Back_Upper_XYZ_R = A_TaiwanBear.multiply(M_RJoint_Back_Upper_XYZ_R);
    ...
    if (q.hasOwnProperty("RJoint_Back_Upper_XYZ_R")) {
        ...
        const Ry_RJoint_Back_Upper_XYZ_R = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    var A_RJoint_Back_Lower_Z_R = A_RJoint_Back_Upper_XYZ_R.multiply(M_RJoint_Back_Lower_Z_R);
    ...
    if (q.hasOwnProperty("RJoint_Back_Lower_Z_R")) {
        ...
        A_RJoint_Back_Lower_Z_R = A_RJoint_Back_Lower_Z_R.multiply(Rz_RJoint_Back_Lower_Z_R);  
    }   


    const M_RJoint_Back_Ankle_Z_R = new Matrix4(1.0,0.0,0.0,0.633785605430603,1.5741393721903615e-22,1.0,2.384185791015625e-07,-2.160634693382235e-07,0.0,-2.384185791015625e-07,1.0,1.9789455052432459e-07,0.0,0.0,0.0,1.0);
    var A_RJoint_Back_Ankle_Z_R = A_RJoint_Back_Lower_Z_R.multiply(M_RJoint_Back_Ankle_Z_R);
    ...
    if (q.hasOwnProperty("RJoint_Back_Ankle_Z_R")) {
        ...
        A_RJoint_Back_Ankle_Z_R = A_RJoint_Back_Ankle_Z_R.multiply(Rz_RJoint_Back_Ankle_Z_R);  
    }   


    const M_Effector_Back_R = new Matrix4(-2.741932405569969e-07,-6.278329465203569e-07,1.0,0.2410445213317871,-3.2560508765245514e-21,-1.0,-6.278329465203569e-07,0.13157300651073456,1.0,-1.2117367385097028e-13,2.741932405569969e-07,-0.0003756207588594407,0.0,0.0,0.0,1.0);
    var A_Effector_Back_R = A_RJoint_Back_Ankle_Z_R.multiply(M_Effector_Back_R);
    ...
    var A_RJoint_Torso_XYZ_C = A_TaiwanBear.multiply(M_RJoint_Torso_XYZ_C);
    ...
    if (q.hasOwnProperty("RJoint_Torso_XYZ_C")) {
        ...
        const Ry_RJoint_Torso_XYZ_C = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    var A_RJoint_Front_Upper_XYZ_L = A_RJoint_Torso_XYZ_C.multiply(M_RJoint_Front_Upper_XYZ_L);
    ...
    if (q.hasOwnProperty("RJoint_Front_Upper_XYZ_L")) {
        ...
        const Ry_RJoint_Front_Upper_XYZ_L = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    var A_RJoint_Front_Lower_Z_L = A_RJoint_Front_Upper_XYZ_L.multiply(M_RJoint_Front_Lower_Z_L);
    ...
    if (q.hasOwnProperty("RJoint_Front_Lower_Z_L")) {
        ...
        A_RJoint_Front_Lower_Z_L = A_RJoint_Front_Lower_Z_L.multiply(Rz_RJoint_Front_Lower_Z_L);  
    }   


    const M_RJoint_Front_Ankle_Z_L = new Matrix4(1.0,0.0,0.0,0.5520808696746826,-2.491518845517339e-22,1.0,-2.2876067581066115e-21,-0.00918277446180582,0.0,-2.2876067581066115e-21,1.0,-3.109511510501761e-07,0.0,0.0,0.0,1.0);
    var A_RJoint_Front_Ankle_Z_L = A_RJoint_Front_Lower_Z_L.multiply(M_RJoint_Front_Ankle_Z_L);
    ...
    if (q.hasOwnProperty("RJoint_Front_Ankle_Z_L")) {
        ...
        A_RJoint_Front_Ankle_Z_L = A_RJoint_Front_Ankle_Z_L.multiply(Rz_RJoint_Front_Ankle_Z_L);  
    }   


    const M_Effector_Front_L = new Matrix4(1.5099581673894136e-07,8.026785849324369e-07,1.0,0.18844406306743622,5.684341886080802e-14,-1.0,8.026785280890181e-07,-0.050207819789648056,1.0,-6.06005453067035e-14,-1.5099580252808664e-07,0.007086289115250111,0.0,0.0,0.0,1.0);
    var A_Effector_Front_L = A_RJoint_Front_Ankle_Z_L.multiply(M_Effector_Front_L);
    ...
    var A_RJoint_Front_Upper_XYZ_R = A_RJoint_Torso_XYZ_C.multiply(M_RJoint_Front_Upper_XYZ_R);
    ...
    if (q.hasOwnProperty("RJoint_Front_Upper_XYZ_R")) {
        ...
        const Ry_RJoint_Front_Upper_XYZ_R = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    var A_RJoint_Front_Lower_Z_R = A_RJoint_Front_Upper_XYZ_R.multiply(M_RJoint_Front_Lower_Z_R);
    ...
    if (q.hasOwnProperty("RJoint_Front_Lower_Z_R")) {
        ...
        A_RJoint_Front_Lower_Z_R = A_RJoint_Front_Lower_Z_R.multiply(Rz_RJoint_Front_Lower_Z_R);  
    }   


    const M_RJoint_Front_Ankle_Z_R = new Matrix4(1.0,0.0,0.0,0.5520808696746826,4.55698723209689e-23,1.0,-2.1472023911872446e-23,0.009183092042803764,0.0,-2.1472020756428825e-23,1.0,-4.730811653530509e-08,0.0,0.0,0.0,1.0);
    var A_RJoint_Front_Ankle_Z_R = A_RJoint_Front_Lower_Z_R.multiply(M_RJoint_Front_Ankle_Z_R);
    ...
    if (q.hasOwnProperty("RJoint_Front_Ankle_Z_R")) {
        ...
        A_RJoint_Front_Ankle_Z_R = A_RJoint_Front_Ankle_Z_R.multiply(Rz_RJoint_Front_Ankle_Z_R);  
    }   


    const M_Effector_Front_R = new Matrix4(-8.742284052232208e-08,-6.278329465203569e-07,1.0,0.18844377994537354,1.359421531208789e-22,-1.0,-6.278329465203569e-07,0.050207775086164474,1.0,-6.433025499016226e-14,8.742283341689472e-08,0.007086239755153656,0.0,0.0,0.0,1.0);
    var A_Effector_Front_R = A_RJoint_Front_Ankle_Z_R.multiply(M_Effector_Front_R);
    ...
    var A_RJoint_Head_XYZ_C = A_RJoint_Torso_XYZ_C.multiply(M_RJoint_Head_XYZ_C);
    ...
    if (q.hasOwnProperty("RJoint_Head_XYZ_C")) {
        ...
        const Ry_RJoint_Head_XYZ_C = new Matrix4(Math.cos(y), 0, Math.sin(y), 0, 0, 1, 0, 0, - Math.sin(y), Math.cos(y), 0, 0, 0, 0, 0, 1);
    ...
    const M_Effector_Head_C = new Matrix4(-4.371136341774218e-08,-1.1920928955078125e-07,1.0,0.9635696411132812,1.0,-2.6037946958593593e-14,4.37113598650285e-08,4.211892346006607e-08,1.9894737170612214e-14,1.0,1.1920928955078125e-07,-0.44918084144592285,0.0,0.0,0.0,1.0);
    var A_Effector_Head_C = A_RJoint_Head_XYZ_C.multiply(M_Effector_Head_C);
